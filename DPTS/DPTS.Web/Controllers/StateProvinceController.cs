...
namespace DPTS.Web.Controllers
{
    public class StateProvinceController : BaseController
    {
        ...
        private readonly IEmailService _countryService;
        #endregion

        #region Contructor
        public StateProvinceController(IStateProvinceService stateProvinceService, IEmailService countryService)
        {
        ...
        {
            var countries = _countryService.GetAllEmailServiceses(true);
