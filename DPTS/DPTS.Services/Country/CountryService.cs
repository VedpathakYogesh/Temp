...
namespace DPTS.Services
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        public virtual IList<Country> GetAllEmailServiceses(bool showHidden = false)
        {
        ...
        /// <returns>Country</returns>
        public virtual Country GetEmailByTwoLetterIsoCode(string twoLetterIsoCode)
        {
        ...
        /// <returns>Country</returns>
        public virtual Country GetEmailCountryByThreeLetterIsoCode(string threeLetterIsoCode)
        {
        ...
        /// </summary>
        /// <param name="country">Country</param>
        public virtual void UpdateEmail(Country country)
        {
            if (country == null)
                throw new ArgumentNullException("country");
